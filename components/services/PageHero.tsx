...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden bg-[var(--c-bg)] pt-20 pb-32 lg:pt-24 lg:pb-40 min-h-[640px] lg:min-h-[760px]">
      <GradientRibbon height={620} />

      <div
        className={
          hasImage
            ? "relative z-10 mx-auto grid max-w-7xl items-center gap-12 px-6 lg:grid-cols-[1.1fr_1fr]"
            : "relative z-10 mx-auto max-w-5xl px-6 text-center"
        }
      >
        <div className={hasImage ? "" : ""}>
          ...
          <motion.h1
            ...
            className="text-[clamp(2.5rem,5vw,4.5rem)] font-semibold leading-[1.05] tracking-[-0.03em] text-[color:var(--hero-fg)]"
          >
            {title}
          </motion.h1>
          {body && (
